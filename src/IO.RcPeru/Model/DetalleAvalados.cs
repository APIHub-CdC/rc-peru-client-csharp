...
{
    [DataContract]
    public partial class DetalleAvalados :  IEquatable<DetalleAvalados>, IValidatableObject
    {
        public DetalleAvalados(string periodo = default(string), string idCalificacion = default(string), string idTipoDocumento = default(string), string documento = default(string), string nombre = default(string), string entidad = default(string), float? saldo = default(float?))
        {
        ...
        {
            return this.Equals(input as DetalleAvalados);
        }
        public bool Equals(DetalleAvalados input)
        {
            if (input == null)
                return false;
            return 
