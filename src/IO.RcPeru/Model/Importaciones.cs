...
{
    [DataContract]
    public partial class Importaciones :  IEquatable<Importaciones>, IValidatableObject
    {
        public Importaciones(string periodo = default(string), float? monto = default(float?))
        {
        ...
        {
            return this.Equals(input as Importaciones);
        }
        public bool Equals(Importaciones input)
        {
            if (input == null)
                return false;
            return 
