...
using System.Linq;
using RestSharp;
using IO.RcPeru.Client;
using IO.RcPeru.Model;

namespace IO.RcPeru.Api
{
    public interface IReporteDeCrditoPerApi : IApiAccessor
    {
        #region Synchronous Operations
        Respuesta GetRC (string xApiKey, string username, string password, Peticion request);
        ApiResponse<Respuesta> GetRCWithHttpInfo (string xApiKey, string username, string password, Peticion request);
        #endregion Synchronous Operations
    }
    public partial class ReporteDeCrditoPerApi : IReporteDeCrditoPerApi
    {
        private IO.RcPeru.Client.ExceptionFactory _exceptionFactory = (name, response) => null;
        public ReporteDeCrditoPerApi(String basePath)
        {
            this.Configuration = new IO.RcPeru.Client.Configuration(basePath);
            ExceptionFactory = IO.RcPeru.Client.Configuration.DefaultExceptionFactory;
        }
        public String GetBasePath()
        {
            return this.Configuration.ApiClient.RestClient.BaseUrl.ToString();
        }
        public IO.RcPeru.Client.Configuration Configuration {get; set;}
        public IO.RcPeru.Client.ExceptionFactory ExceptionFactory
        {
            get
            {
        ...
        public Respuesta GetRC (string xApiKey, string username, string password, Peticion request)
        {
             ApiResponse<Respuesta> localVarResponse = GetRCWithHttpInfo(xApiKey, username, password, request);
             return localVarResponse.Data;
        }
        public ApiResponse< Respuesta > GetRCWithHttpInfo (string xApiKey, string username, string password, Peticion request)
        {
            if (xApiKey == null)
