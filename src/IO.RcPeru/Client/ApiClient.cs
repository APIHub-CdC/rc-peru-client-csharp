...
using IO.RcPeru.Interceptor;

namespace IO.RcPeru.Client
{
    public partial class ApiClient
    {
        private IO.RcPeru.Client.Configuration Configuration;
        ...
        private void InterceptResponse(IRestRequest request, IRestResponse response){
            ...
            if(isVerify){
                Debug.WriteLine("x-signature has been verified successfully");
            }
            else{
                Debug.WriteLine("Could not verify the x-signature header");
            }
        }
